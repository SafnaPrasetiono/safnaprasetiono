    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center bg-white rounded-3 border shadow-sm p-3">
            <div class="p-3" style="width: 270px">
                <img src="{{ url('/images/auth/password.png') }}" alt="" class="img-fluid">
            </div>
            <div class="ms-0 ms-md-4">
                ...
                <button wire:click='show' type="button" class="btn btn-primary rounded-0">Set Password</button>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="mb-3 text-center py-3">
                        <img src="{{ url('/images/auth/password.png') }}" alt="" class="img-fluid w-50 mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button wire:click='setup' type="button" class="btn btn-custom-1">Simpan</button>
                  </div>
            </div>
        </div>
    </div>
